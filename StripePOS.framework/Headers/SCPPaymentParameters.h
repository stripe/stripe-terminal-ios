...
/**
 Parameters for starting a payment with `SCPTerminal.attachSource`
 */
@interface SCPPaymentParameters : NSObject
...
/**
 Initializes SCPPaymentParameters with the given parameters.
