...
/**
 Whether this update was synthetically generated by the SDK for testing purposes
 via `SCPTestReaderUpdate`, rather than being a real update from the backend.
 */
@property (nonatomic, readonly) BOOL isTestUpdate;
