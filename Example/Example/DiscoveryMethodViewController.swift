...
class DiscoveryMethodViewController: TableViewController {
    ...
    private func updateContent() {
        dataSource.sections = [
            Section(header: "", rows: [
                Row(text: DiscoveryMethod.bluetoothScan.description, selection: { [unowned self] in
            ...
            Section(header: "", rows: [
                Row(text: DiscoveryMethod.bluetoothProximity.description, selection: { [unowned self] in
            ...
            Section(header: "", rows: [
                Row(text: DiscoveryMethod.internet.description, selection: { [unowned self] in
