...
typedef NS_ERROR_ENUM(SCPErrorDomain, SCPError){
     ...
     */
    SCPErrorNotAllowed = 2860,
    /**
     The mobile device on which the app is running is in an unsupported configuration.
     Verify that the device is running a supported version of iOS and that the mobile device has the
     capability you are attempting to use.
     */
    SCPErrorUnsupportedConfiguration = 2870,
    /**
     The mobile device on which the app is running must have a passcode set.
     */
    SCPErrorPasscodeNotEnabled = 2880,
    /**
     The card reader cannot be used while a phone call is active.
     */
    SCPErrorNotAllowedDuringCall = 2890,
    /**
     An attempt was made to charge an amount not supported by the reader.
     */
    SCPErrorInvalidAmount = 2900,
    /**
     An attempt was made to charge an amount in a currency not supported by the reader.
     */
    SCPErrorInvalidCurrency = 2910,
    /**
     Failed to link merchant because there is no iCloud user signed in.
     Direct the user to sign into an appropriate iCloud account via iOS Settings and try again.
     */
    SCPErrorAppleBuiltInReaderAccountLinkingRequiresiCloudSignIn = 2920,
    /**
     The user cancelled account linking.
     */
    SCPErrorAppleBuiltInReaderAccountLinkingCanceled = 2930,
     ...
     */
    SCPErrorReaderNotAccessibleInBackground = 3890,
    /**
     Preparing the Apple Built-In reader to collect payments failed.
     Try connecting again.
     */
    SCPErrorAppleBuiltInReaderFailedToPrepare = 3900,
    /**
     This device cannot be used to process using the Apple Built-In reader as it has been banned.
     Contact support for details.
     */
    SCPErrorAppleBuiltInReaderDeviceBanned = 3910,
    /**
     The operation could not be completed because the merchant account is not linked.
     Try connecting again.
     */
    SCPErrorAppleBuiltInReaderAccountNotLinked = 3920,
    /**
     Failed to link because merchant is already linked with an Apple ID.
     Try linking again, but this time, use a different Apple ID.
     */
    SCPErrorAppleBuiltInReaderAccountAlreadyLinked = 3930,
    /**
     Failed to link merchant to the provided Apple ID.
     Ensure the Apple ID is still active and in a good standing and try again.
     */
    SCPErrorAppleBuiltInReaderAccountLinkingFailed = 3940,
    /**
     ...
     */
    SCPErrorInvalidLocationIdParameter = 3970,
