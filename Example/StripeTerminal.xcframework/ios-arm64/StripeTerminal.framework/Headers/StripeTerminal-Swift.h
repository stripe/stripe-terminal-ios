...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull scp_tapToPayReaderErrorDomain;)
+ (NSString * _Nonnull)scp_tapToPayReaderErrorDomain SWIFT_WARN_UNUSED_RESULT;
/// Tap To Pay reader error User Info error name key.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull scp_tapToPayReaderErrorUserInfoNameKey;)
+ (NSString * _Nonnull)scp_tapToPayReaderErrorUserInfoNameKey SWIFT_WARN_UNUSED_RESULT;
/// Tap To Pay reader error User Info reader message key.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull scp_tapToPayReaderErrorUserInfoReaderMessageKey;)
+ (NSString * _Nonnull)scp_tapToPayReaderErrorUserInfoReaderMessageKey SWIFT_WARN_UNUSED_RESULT;
/// Tap To Pay reader error User Info device banned until date key.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull scp_tapToPayReaderErrorUserInfoDeviceBannedUntilDateKey;)
+ (NSString * _Nonnull)scp_tapToPayReaderErrorUserInfoDeviceBannedUntilDateKey SWIFT_WARN_UNUSED_RESULT;
/// Tap To Pay reader error User Info device prepare failed reason key.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull scp_tapToPayReaderErrorUserInfoPrepareFailedReasonKey;)
+ (NSString * _Nonnull)scp_tapToPayReaderErrorUserInfoPrepareFailedReasonKey SWIFT_WARN_UNUSED_RESULT;
/// seealso:
/// <code>TapToPayReaderErrorCode.unknown</code>
///
/// returns:
/// A new instance of the receiver indicating an unknown failure in the Tap To Pay reader.
+ (NSError * _Nonnull)scp_unknownTapToPayReaderError SWIFT_WARN_UNUSED_RESULT;
/// seealso:
/// <code>TapToPayReaderErrorCode.invalidAmount</code>
///
/// returns:
...
/// seealso:
/// <code>TapToPayReaderErrorCode.invalidCurrency</code>
///
/// returns:
...
/// seealso:
/// <code>TapToPayReaderErrorCode.invalidTransactionType</code>
///
/// returns:
...
/// seealso:
/// <code>TapToPayReaderErrorCode.notReady</code>
///
/// returns:
...
/// seealso:
/// <code>TapToPayReaderErrorCode.unexpectedNil</code>
///
/// returns:
...
/// seealso:
/// <code>TapToPayReaderErrorCode.readCanceled</code>
///
/// returns:
...
@protocol SCPTapToPayReaderAccountLinkingDelegate;
@protocol SCPTapToPayReaderPrepareDelegate;
@protocol SCPTapToPayReaderTransactionDelegate;
enum SCPTapToPayReaderTransactionType : NSInteger;
@class NSDecimalNumber;

/// Bridge class protocol for the Tap To Pay reader API.
...
SWIFT_PROTOCOL_NAMED("TapToPayReaderProtocol")
@protocol SCPTapToPayReader <NSObject>
/// Determines whether the use of the Tap To Pay reader adapter is supported on the
...
/// Determines whether the current device supports Tap To Pay readers and, if so, returns
...
/// If unsuccessful, invoked with an <code>NSError</code> in the <code>SCPTapToPayReaderErrorDomain</code>.
///
...
@property (nonatomic, readonly, strong) SCPTapToPayConnectionConfiguration * _Nonnull connectionConfiguration;
...
@property (nonatomic, weak) id <SCPTapToPayReaderAccountLinkingDelegate> _Nullable accountLinkingDelegate;
/// Delegate specific to the reader preparation process.
@property (nonatomic, weak) id <SCPTapToPayReaderPrepareDelegate> _Nullable prepareDelegate;
/// Delegate specific to the process of performing a transaction.
@property (nonatomic, weak) id <SCPTapToPayReaderTransactionDelegate> _Nullable transactionDelegate;
/// \param crid The unique identifier associated with the reader.
///
/// \param connectionConfiguration Tap To Pay connection configuration.
///
...
- (nonnull instancetype)initWithReaderIdentifier:(NSString * _Nonnull)crid connectionConfiguration:(SCPTapToPayConnectionConfiguration * _Nonnull)connectionConfiguration isSimulated:(BOOL)isSimulated;
...
///
/// throws:
/// <code>NSError</code> in the <code>SCPTapToPayReaderErrorDomain</code>.
...
/// throws:
/// <code>NSError</code> in the <code>SCPTapToPayReaderErrorDomain</code>.
- (BOOL)performTransactionWithType:(enum SCPTapToPayReaderTransactionType)transactionType amount:(NSDecimalNumber * _Nullable)amount currencyCode:(NSString * _Nonnull)currencyCode error:(NSError * _Nullable * _Nullable)error;
/// Capture a PIN for a previously completed transaction attempt.
/// note:
/// Not available on simulated readers.
/// note:
/// Uses the same delegate callbacks as <code>TapToPayReaderProtocol.performTransaction(type:amount:currencyCode:)</code>
...
/// capture attempt. This value is returned as <code>paymentCardId</code> in the <code>TapToPayReaderTransactionDelegate</code>’s
/// <code>tapToPayReader(_:didCollectPaymentCard:generalCardData:paymentCardId:merchantReference:)</code>
/// delegate method.
///
///
/// throws:
...
/// throws:
/// <code>NSError</code> in the <code>SCPTapToPayReaderErrorDomain</code>.
- (BOOL)performMockTransactionWithType:(enum SCPTapToPayReaderTransactionType)transactionType amount:(NSDecimalNumber * _Nullable)amount currencyCode:(NSString * _Nonnull)currencyCode error:(NSError * _Nullable * _Nullable)error;
@end


/// Bridge class for the Tap To Pay reader API.
/// The ProximityReader framework in which it is exposed leverages Swift Concurrency and is
/// not Objective-C compatible. The core of the Stripe Terminal SDK remains written in Objective-C.
...
/// seealso:
/// TapToPayReaderProtocol
/// TODO:KINGS-263: This class could be simplified and shared logic DRY’d up and preconditions removed.
SWIFT_CLASS_NAMED("TapToPayReader")
@interface SCPTapToPayReader : NSObject <SCPTapToPayReader>
+ (BOOL)isSupportedWithSimulated:(BOOL)simulated error:(NSError * _Nullable * _Nullable)error;
+ (void)discoverAvailableReaderIdentifiersWithCompletion:(void (^ _Nonnull)(NSSet<NSString *> * _Nullable, NSError * _Nullable))completion;
- (nonnull instancetype)initWithReaderIdentifier:(NSString * _Nonnull)crid connectionConfiguration:(SCPTapToPayConnectionConfiguration * _Nonnull)connectionConfiguration isSimulated:(BOOL)simulated OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull readerIdentifier;
@property (nonatomic, readonly) BOOL isSimulated;
@property (nonatomic, readonly, strong) SCPTapToPayConnectionConfiguration * _Nonnull connectionConfiguration;
@property (nonatomic, copy) NSString * _Nullable merchantReference;
...
SWIFT_PROTOCOL_NAMED("TapToPayReaderAccountLinkingDelegate")
@protocol SCPTapToPayReaderAccountLinkingDelegate <NSObject>
/// The specified merchant account was successfully linked.
/// \param reader Tap To Pay reader.
///
- (void)tapToPayReaderDidLinkAccount:(id <SCPTapToPayReader> _Nonnull)reader;
/// The specified merchant account was already successfully linked with the receiver.
/// \param reader Tap To Pay reader.
///
- (void)tapToPayReaderDidPreviouslyLinkAccount:(id <SCPTapToPayReader> _Nonnull)reader;
/// An error occurred while attempting to link the specified merchant account with the receiver.
/// \param reader Tap To Pay reader.
///
/// \param error A description of the failure in the <code>SCPTapToPayReaderErrorDomain</code>.
///
- (void)tapToPayReader:(id <SCPTapToPayReader> _Nonnull)reader didFailToLinkAccountWithError:(NSError * _Nonnull)error;
@end
...
typedef SWIFT_ENUM_NAMED(NSInteger, SCPTapToPayReaderErrorCode, "TapToPayReaderErrorCode", open) {
/// An unknown error.
  SCPTapToPayReaderErrorCodeUnknown = 0,
/// An SDK error indicating that an unexpected <code>nil</code> value was encountered.
  SCPTapToPayReaderErrorCodeUnexpectedNil = 1,
/// An invalid transaction type was specified for the current operation.
  SCPTapToPayReaderErrorCodeInvalidTransactionType = 2,
/// The mobile device must have a passcode enabled to use the Tap To Pay reader.
  SCPTapToPayReaderErrorCodePasscodeDisabled = 3,
/// Usually indicates entitlement, invalid application bundle, configuration issue or partner token issue.
  SCPTapToPayReaderErrorCodeNotAllowed = 4,
/// It is not possible to interact with the Tap To Pay reader while the app is backgrounded.
  SCPTapToPayReaderErrorCodeBackgroundRequestNotAllowed = 5,
/// Unsupported hardware, problem with the device.
  SCPTapToPayReaderErrorCodeUnsupported = 6,
/// Current OS version is not supported.
  SCPTapToPayReaderErrorCodeOsVersionNotSupported = 7,
/// Device model is not supported.
  SCPTapToPayReaderErrorCodeModelNotSupported = 8,
/// Network error, unable to reach server.
  SCPTapToPayReaderErrorCodeNetworkError = 9,
/// Authentication during connection to server
  SCPTapToPayReaderErrorCodeNetworkAuthenticationError = 10,
/// Unable to connect to internal service.
  SCPTapToPayReaderErrorCodeServiceConnectionError = 11,
/// Reader session is not ready. The reader connection must be re-initialized.
  SCPTapToPayReaderErrorCodeNotReady = 12,
/// Reader token not valid, cannot be empty.
  SCPTapToPayReaderErrorCodeEmptyReaderToken = 13,
/// Reader token not valid, check description for more details.
  SCPTapToPayReaderErrorCodeInvalidReaderToken = 14,
/// Prepare failed, config setup issues. The reader connection must be re-initialized.
  SCPTapToPayReaderErrorCodePrepareFailed = 15,
/// Reader session expired, too long since last used. The reader connection must be re-initialized.
  SCPTapToPayReaderErrorCodePrepareExpired = 16,
/// Reader token is expired. The reader connection must be re-initialized.
  SCPTapToPayReaderErrorCodeTokenExpired = 17,
/// This device cannot be used to process using the Tap To Pay reader anymore.
  SCPTapToPayReaderErrorCodeDeviceBanned = 18,
/// Reader internal memory full.
  SCPTapToPayReaderErrorCodeReaderMemoryFull = 19,
/// Reader is busy, unable to prepare the reader. The reader connection must be re-initialized.
  SCPTapToPayReaderErrorCodeReaderBusy = 20,
/// The merchant account is not linked. Link the account and re-initialize the connection.
  SCPTapToPayReaderErrorCodeAccountNotLinked = 21,
/// Failed to link merchant to this Apple ID. Ensure Apple ID is still active and in a good standing and try again.
  SCPTapToPayReaderErrorCodeAccountLinkingFailed = 22,
/// Linking the merchant requires iCloud sign in.
  SCPTapToPayReaderErrorCodeAccountLinkingRequiresiCloudSignIn = 23,
/// An error indicating the user cancelled the linking operation.
  SCPTapToPayReaderErrorCodeAccountLinkingCancelled = 24,
/// An error that indicates the system couldn’t check the account status of the merchant.
  SCPTapToPayReaderErrorCodeAccountLinkingCheckFailed = 25,
/// An error that indicates the linked Apple ID account has been deactivated by the merchant.
  SCPTapToPayReaderErrorCodeAccountDeactivated = 26,
/// Merchant is blocked.
  SCPTapToPayReaderErrorCodeMerchantBlocked = 27,
/// Merchant is invalid.
  SCPTapToPayReaderErrorCodeInvalidMerchant = 28,
/// Read not allowed at this time. Validate entitlements to proceed.
  SCPTapToPayReaderErrorCodeReadNotAllowed = 29,
/// It is not possible to interact with the Tap To Pay reader while the app is backgrounded.
  SCPTapToPayReaderErrorCodeReadFromBackgroundError = 30,
/// Unable to connect to internal UI or other services.
  SCPTapToPayReaderErrorCodeReaderServiceConnectionError = 31,
/// General reader service internal state issue, unexpected error, etc…
  SCPTapToPayReaderErrorCodeReaderServiceError = 32,
/// No reader session or not ready. The reader connection must be re-initialized.
  SCPTapToPayReaderErrorCodeNoReaderSession = 33,
/// Reader session expired and unable to refresh. The reader connection must be re-initialized.
  SCPTapToPayReaderErrorCodeReaderSessionExpired = 34,
/// Unable to refresh reader session as configuration token is expired. The reader connection must be re-initialized.
  SCPTapToPayReaderErrorCodeReaderTokenExpired = 35,
/// Unable to refresh reader session due to network error.
  SCPTapToPayReaderErrorCodeReaderSessionNetworkError = 36,
/// Auth error, while refreshing reader session.
  SCPTapToPayReaderErrorCodeReaderSessionAuthenticationError = 37,
/// Reader is busy with another session. Try again later.
  SCPTapToPayReaderErrorCodeReaderSessionBusy = 38,
/// Current read or reader session cancelled.
  SCPTapToPayReaderErrorCodeReadCancelled = 39,
/// Invalid amount, must be a positive.
  SCPTapToPayReaderErrorCodeInvalidAmount = 40,
/// Invalid or unsupported currency code.
  SCPTapToPayReaderErrorCodeInvalidCurrency = 41,
/// NFC is disabled. NFC must be enabled to proceed.
  SCPTapToPayReaderErrorCodeNfcDisabled = 42,
/// It is not possible to interact with the Tap To Pay reader while the app is backgrounded.
  SCPTapToPayReaderErrorCodeReadNotAllowedDuringCall = 43,
/// An error occurred while attempting to read the payment card.
  SCPTapToPayReaderErrorCodeCardReadFailed = 44,
/// Unable to proceed with payment read due to internal failure.
  SCPTapToPayReaderErrorCodePaymentReadFailed = 45,
/// The payment card declined the transaction.
  SCPTapToPayReaderErrorCodePaymentCardDeclined = 46,
/// The preferred AID specified in the transaction request is invalid.
  SCPTapToPayReaderErrorCodeInvalidPreferredAID = 47,
/// An error occurred when capturing the PIN.
  SCPTapToPayReaderErrorCodePinEntryFailed = 48,
/// An error that indicates an invalid PIN token.
  SCPTapToPayReaderErrorCodePinTokenInvalid = 49,
/// The current PIN capture was not completed in allowed time.
  SCPTapToPayReaderErrorCodePinEntryTimeout = 50,
/// The current PIN capture was cancelled, also cancelling any ongoing read operation.
  SCPTapToPayReaderErrorCodePinCancelled = 51,
/// The time window allowing for a PIN capture after a card read has expired.
  SCPTapToPayReaderErrorCodePinNotAllowed = 52,
};


/// Delegate methods pertaining to the process of preparing an Tap To Pay reader.
SWIFT_PROTOCOL_NAMED("TapToPayReaderPrepareDelegate")
@protocol SCPTapToPayReaderPrepareDelegate <NSObject>
/// The receiver reported progress during the preparation step.
/// \param reader Tap To Pay reader.
///
/// \param progress Reader preparation progress in the range (0, 1).
///
- (void)tapToPayReader:(id <SCPTapToPayReader> _Nonnull)reader didReportPrepareProgress:(float)progress;
/// The receiver was prepared successfully.
/// \param reader Tap To Pay reader.
///
- (void)tapToPayReaderDidPrepare:(id <SCPTapToPayReader> _Nonnull)reader;
/// The receiver could not be prepared successfully.
/// \param reader Tap To Pay reader.
///
/// \param error A description of the failure in the <code>SCPTapToPayReaderErrorDomain</code>.
///
- (void)tapToPayReader:(id <SCPTapToPayReader> _Nonnull)reader didFailToPrepareWithError:(NSError * _Nonnull)error;
@end


@class SCPTapToPayReaderTransactionEvent;

/// Delegate methods pertaining to carrying out transactions.
SWIFT_PROTOCOL_NAMED("TapToPayReaderTransactionDelegate")
@protocol SCPTapToPayReaderTransactionDelegate <NSObject>
...
/// \param merchantReference Merchant reference.
///
- (void)tapToPayReader:(id <SCPTapToPayReader> _Nonnull)reader didCollectPaymentCard:(NSString * _Nullable)data generalCardData:(NSString * _Nullable)generalCardData paymentCardId:(NSString * _Nonnull)paymentCardId merchantReference:(NSString * _Nonnull)merchantReference;
/// An attempt to perform a transaction failed.
/// \param reader Tap To Pay reader.
///
/// \param error A description of the failure in the <code>SCPTapToPayReaderErrorDomain</code>.
///
- (void)tapToPayReader:(id <SCPTapToPayReader> _Nonnull)reader didFailToPerformTransaction:(NSError * _Nonnull)error;
...
///
- (void)tapToPayReader:(id <SCPTapToPayReader> _Nonnull)reader didReportTransactionEvent:(SCPTapToPayReaderTransactionEvent * _Nonnull)event;
/// An attempt to cancel a transaction failed.
/// \param reader Tap To Pay reader.
///
/// \param error A description of the failure in the <code>SCPTapToPayReaderErrorDomain</code>.
///
- (void)tapToPayReader:(id <SCPTapToPayReader> _Nonnull)reader didFailToCancelTransaction:(NSError * _Nonnull)error;
/// A mock transaction completed successfully.
/// \param reader Tap to Pay reader.
///
- (void)tapToPayReaderDidCompleteMockTransaction:(id <SCPTapToPayReader> _Nonnull)reader;
@end

enum SCPTapToPayReaderTransactionEventCode : NSInteger;

/// Tap To Pay Reader Transaction Event.
/// This class wraps a transaction event code and associated metadata into an Objective-C
/// compatable object representation.
SWIFT_CLASS_NAMED("TapToPayReaderTransactionEvent")
@interface SCPTapToPayReaderTransactionEvent : NSObject
/// The name of the reader transaction event suitable for logging.
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
/// Transaction event code.
@property (nonatomic, readonly) enum SCPTapToPayReaderTransactionEventCode code;
///
/// returns:
/// A new instance of the receiver configured with an <code>unknown</code> event.
- (nonnull instancetype)init;
- (BOOL)isEqualToTransactionEvent:(SCPTapToPayReaderTransactionEvent * _Nonnull)other SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM_NAMED(NSInteger, SCPTapToPayReaderTransactionEventCode, "TapToPayReaderTransactionEventCode", open) {
/// Unknown reader event code.
  SCPTapToPayReaderTransactionEventCodeUnknown = 0,
/// The reader is ready for someone to move their card within range of the iPhone.
  SCPTapToPayReaderTransactionEventCodeReadyForTap = 1,
/// The reader detected the presence of a card.
  SCPTapToPayReaderTransactionEventCodeCardDetected = 2,
/// The consumer can move the card away from the device.
  SCPTapToPayReaderTransactionEventCodeRemoveCard = 3,
/// The reader completed the card read process.
  SCPTapToPayReaderTransactionEventCodeCompleted = 4,
/// A visual indication has been presented requesting the customer try again.
  SCPTapToPayReaderTransactionEventCodeRetry = 5,
/// A read operation was canceled.
  SCPTapToPayReaderTransactionEventCodeReadCanceled = 6,
/// The read operation did not complete.
  SCPTapToPayReaderTransactionEventCodeReadNotCompleted = 7,
/// PIN entry was requested.
  SCPTapToPayReaderTransactionEventCodePinEntryRequested = 8,
/// PIN entry was completed.
  SCPTapToPayReaderTransactionEventCodePinEntryCompleted = 9,
};

/// The kind of a transaction.
typedef SWIFT_ENUM_NAMED(NSInteger, SCPTapToPayReaderTransactionType, "TapToPayReaderTransactionType", open) {
  SCPTapToPayReaderTransactionTypeUnknown = 0,
/// Charge the specified amount.
  SCPTapToPayReaderTransactionTypePurchase = 1,
