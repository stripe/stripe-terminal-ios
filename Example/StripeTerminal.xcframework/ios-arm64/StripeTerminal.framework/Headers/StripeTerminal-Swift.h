...
/// \param error A description of the failure in the <code>SCPAppleBuiltInReaderErrorDomain</code>.
///
- (void)appleBuiltInReader:(id <SCPAppleBuiltInReader> _Nonnull)reader didFailToPerformTransactionOfType:(enum SCPAppleBuiltInReaderTransactionType)type error:(NSError * _Nonnull)error;
