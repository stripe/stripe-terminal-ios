...
/**
 Implement this protocol to handle events when updating a reader.
 */
NS_SWIFT_NAME(UpdateReaderDelegate)
...
/**
 ...
 `didReportReaderUpdateProgress` delegate method to follow the
 progress of the update. After the update completes, the
 `didCompleteReaderUpdate` delegate method will be called.
