...
#ifndef STATIC_SWIFT_H
#define STATIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Static",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface DataSource (SWIFT_EXTENSION(Static)) <UITableViewDelegate>
...
SWIFT_CLASS("_TtC6Static25SegmentedControlAccessory")
@interface SegmentedControlAccessory : UISegmentedControl
...
SWIFT_CLASS("_TtC6Static15SwitchAccessory")
@interface SwitchAccessory : UISwitch
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
/// Table view controller with a <code>DataSource</code> setup to use its <code>tableView</code>.
