...
## Try the example app
The Stripe Terminal SDK includes an example iOS app, which you can use to familiarize yourself with the SDK and reader before starting your own integration. To get started:

Navigate to Stripe Terminal iOS on [GitHub](https://github.com/stripe/stripe-terminal-ios) and clone the repository.
...
3. Build and run the app. The Stripe Terminal SDK includes a reader simulator, so you can get started without any physical hardware.
